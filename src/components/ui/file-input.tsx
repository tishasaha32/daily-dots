			...
			>
				...
				>
					{({ getRootProps, getInputProps }) => (
						<div
							className={cn(
								"flex w-full cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border border-border bg-background px-3 py-2 text-center outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
						...
						>
							...
							<div className="flex w-full flex-col items-center justify-center gap-2">
								<h1 className="text-sm text-gray-500 sm:text-base">
